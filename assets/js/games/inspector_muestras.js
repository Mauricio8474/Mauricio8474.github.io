/* Extracted from games/inspector_muestras.html on 2025-08-28T03:35:45.659Z */
...
// Redirige si no hay usuario autenticado
        ...
        const scenarios = [
            ...
            {
                id: 'scores',
                title: 'Puntajes de Exámenes',
                description: 'Analiza el rendimiento académico en pruebas estandarizadas',
                population: {
                    mean: 75,
                    stdDev: 12,
                    size: 100000,
                ...
                context: 'El Ministerio de Educación necesita evaluar el rendimiento académico nacional en matemáticas.'
            },
            {
                id: 'income',
                ...
                context: 'El DANE requiere estimar el ingreso familiar promedio para políticas sociales.'
            },
            {
                id: 'satisfaction',
                title: 'Satisfacción del Cliente',
                description: 'Evalúa la satisfacción en una escala de 1 a 10',
                population: {
                    mean: 7.2,
                    stdDev: 1.5,
                    size: 25000,
                ...
                context: 'Una empresa de servicios quiere medir la satisfacción de sus clientes.'
            }
        ];
        ...
        const questions = {
            heights: [
                {
                    text: "Con base en el intervalo de confianza calculado, ¿qué puedes concluir sobre la altura promedio de los estudiantes?",
                    options: [
                        "La altura promedio poblacional está definitivamente dentro del intervalo",
                        "Hay un [CONFIDENCE]% de probabilidad de que μ esté en el intervalo",
                ...
                {
                    text: "Si aumentamos el tamaño de la muestra, ¿qué pasará con el intervalo de confianza?",
                    options: [
                        "Se hará más ancho",
                        "Se hará más estrecho",
                        "No cambiará",
            ...
            scores: [
                {
                    text: "El error estándar de la media muestral es [SE]. ¿Qué significa esto?",
                    options: [
                ...
                {
                    text: "Si el puntaje promedio nacional real es 78, ¿está dentro de tu intervalo de confianza?",
                    options: [
                        "Sí, siempre estará dentro",
                        "No, nunca estará dentro",
            ...
            income: [
                {
                    ...
                    options: [
                        "Todos los ingresos están en ese rango",
                        "La media poblacional probablemente difiere de la muestral por esa cantidad",
                        "Es el error de medición de la encuesta",
                        "Es la inflación esperada"
                    ],
                    correct: 1
                },
                {
                    text: "¿Por qué es importante usar muestreo para estimar ingresos familiares?",
                    options: [
                        "Es más barato y rápido que un censo completo",
            ...
            satisfaction: [
                {
                    text: "Tu muestra tiene una media de [MEAN]/10. ¿Qué tan confiable es esta estimación?",
                    options: [
                        "Es exactamente igual a la media poblacional",
                        "La confiabilidad depende del tamaño de muestra y variabilidad",
                ...
                {
                    text: "Si quisiéramos un intervalo de confianza más preciso (más estrecho), podríamos:",
                    options: [
                        "Disminuir el nivel de confianza",
                        "Aumentar el tamaño de la muestra",
                        "Ambas opciones anteriores",
                        "No se puede hacer más preciso"
                    ],
                    correct: 2
                }
            ]
        ...
        function takeSample() {
            if (!gameData.currentScenario) {
                alert('¡Selecciona primero un escenario de investigación!');
                return;
            }
            ...
            // Generar muestra aleatoria con distribución normal
            const sample = [];
        ...
        function displaySample() {
            ...
            ).join('') + (remaining > 0 ? `<div class="data-point" style="background: #718096;">+${remaining} más</div>` : '');
        }
        ...
        function displayStatistics() {
            ...
            sampleStats.innerHTML = `
                <div class="stat-row">
                    <span class="stat-name">Media Muestral (x̄)</span>
                    <span class="stat-value">${formatValue(stats.mean, unit)}</span>
                </div>
                <div class="stat-row">
                    <span class="stat-name">Desviación Estándar (s)</span>
                    <span class="stat-value">${formatValue(stats.stdDev, unit)}</span>
                </div>
                <div class="stat-row">
                    <span class="stat-name">Error Estándar</span>
        ...
        function createHistogram() {
            ...
            binCounts.forEach((count, index) => {
                ...
                const height = (count / maxCount) * 200; // Altura máxima de 200px
        ...
        function selectAnswer(selectedIndex) {
            ...
            if (selectedIndex === correctIndex) {
                ...
                feedback.innerHTML = '¡Correcto! 🎉<br>Has demostrado una buena comprensión de la estadística inferencial.';
                gameData.points += 20;
                gameData.correct++;
            } else {
                feedback.className = 'feedback incorrect';
                feedback.innerHTML = 'Incorrecto. 😔<br>Revisa los conceptos de intervalos de confianza y estadística inferencial.';
                gameData.points += 5;
            }
            ...
            if (gameData.correct >= 5) {
                setTimeout(() => {
                    alert('¡Felicitaciones! Has completado el nivel 1. 🏆\n\n¡Sigue practicando para dominar la estadística inferencial!');
                    gameData.level++;
                    gameData.correct = 0;
                    updateStats();
                }, 1500);
        ...
        function newExperiment() {
            ...
            const messages = [
                '¡Excelente! 🔬 Sigue experimentando para dominar la estadística.',
                '¡Muy bien! 📊 Cada muestra te enseña algo nuevo.',
                '¡Fantástico! 📈 La práctica hace al maestro estadístico.',
                '¡Increíble! 🧪 Estás desarrollando intuición estadística.',
                '¡Genial! 🎯 Sigue explorando diferentes escenarios.'
            ];
